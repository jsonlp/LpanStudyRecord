...
public class FileUtils {
    ...
    static final String updateVersionName = "1.2.70.0";
    ...
    static boolean copyBinaryFromAssetsToData(Context context, String fileNameFromAssets, String outputFileName) {
        ...
        try {
            ...
            final FileOutputStream os = new FileOutputStream(new File(filesDirectory.getAbsolutePath() + File.separator + updateVersionName, outputFileName));
    ...
    static String getFFmpeg(Context context) {
        String ffmpegPath = getFilesDirectory(context).getAbsolutePath() + File.separator + updateVersionName + File.separator + FileUtils.ffmpegFileName;
        android.util.Log.d("ffmpeg", "getFFmpeg path=" + ffmpegPath);
        return ffmpegPath;
    }
