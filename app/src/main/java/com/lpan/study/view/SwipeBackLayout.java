...
public class SwipeBackLayout extends ViewGroup {
    ...
    private void findScrollView(ViewGroup viewGroup) {
        if (viewGroup.getChildCount() > 0) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (child instanceof AbsListView/*|| child instanceof NarrowViewPager*/ || child instanceof ScrollView || child instanceof ViewPager || child instanceof WebView) {
                    scrollChild = child;
                    return;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        ensureTarget();
        if (isEnabled() && (mMaxY > 0 && ev.getRawY() <= mMaxY || mMaxY <= 0 )) {
            try {
    ...
    public boolean canChildScrollUp() {
        ...
        if (scrollChild == null) {
            return false;
        } /*else if (scrollChild instanceof NarrowViewPager) {
            return ((NarrowViewPager) scrollChild).getDragDistance() > 0;
        }*/
    ...
    private class ViewDragHelperCallBack extends ViewDragHelper.Callback {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            setBackgroundColor(Color.argb((int)(150 * (1 - fractionScreen)), 0, 0, 0));
        }
    ...
    /**
     * @author lp
     * do something before finish the activity
     */
