...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends
    ...
    //     * is in
    //     * a state where a Pull-to-Refresh can happen. An example of this state
    //     * is
    ...
    public final void setCustomView(View newCustomViewView) {
        setCustomView(newCustomViewView, ViewGroup.LayoutParams.MATCH_PARENT,
    ...
    public final void setCustomView(View newCustomViewView, int width, int height) {
        // If we already have an Empty View, remove it
        if (null != mCustomView) {
            mRefreshableViewWrapper.removeView(mCustomView);
        }

        if (newCustomViewView != null) {
            mCustomView = newCustomViewView;
            mRefreshableViewWrapper.addView(mCustomView, width, height);
        }
    }
     ...
     * when the Android Framework automatically sets the Empty View based
     * on it's ID.
     *
    ...
    private boolean isLastItemVisible() {
        ...
        if (null == adapter || adapter.isEmpty()) {
            ...
            //            if (DEBUG) {
            //                Log.d(TAG, "isLastItemVisible. Last Item Position: " + lastItemPosition
            //                        + " Last Visible Pos: " + lastVisiblePosition);
            //            }

            /**
             * This check should really just be: lastVisiblePosition ==
             * lastItemPosition, but PtRListView internally uses a
             * FooterView which messes the positions up. For me we'll just
             * subtract one to account for it and rely on the inner
