...
public class FlipLoadingLayout extends LoadingLayout {
    ...
    public FlipLoadingLayout(Context context, final PullToRefreshBase.Mode mode, final PullToRefreshBase.Orientation scrollDirection,
    ...
    protected void onLoadingDrawableSet(Drawable imageDrawable) {
        if (null != imageDrawable) {
            ...
            /**
             * We need to set the width/height of the ImageView so that it
             * is square with each side the size of the largest drawable
