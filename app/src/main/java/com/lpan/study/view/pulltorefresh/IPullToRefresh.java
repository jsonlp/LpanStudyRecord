...
public interface IPullToRefresh<T extends View> {
     ...
     * View will only use touch events where the difference in the Y-axis
     * is greater than the difference in the X-axis. This means that the
     * View will not interfere when it is used in a horizontal scrolling
     * View (such as a ViewPager), but will restrict which types of finger
     * scrolls will trigger the View.
     *
     * @param filterEvents - true if you want to filter Touch Events.
     *        Default is true.
     */
    public void setFilterTouchEvents(boolean filterEvents);

    /**
     * Returns a proxy object which allows you to call methods on all of
     * the LoadingLayouts (the Views which show when Pulling/Refreshing).
     * <p/>
     ...
     *
     * @return true - if both PullToRefresh-OverScroll and Android's
     *         inbuilt OverScroll are enabled
     */
    ...
    /**
     * Sets the Widget to be in the refresh state. The UI will be updated
     * to show the 'Refreshing' view.
     *
     * @param doScroll - true if you want to force a scroll to the
     *        Refreshing view.
     */
     ...
     *
     * @param listener - Listener to be used when the Widget has a pull
     *        event to propogate.
     */
     ...
     *
     * @param listener - Listener to be used when the Widget is set to
     *        Refresh
     */
    ...
    /**
     * Sets the Widget to be in the refresh state. The UI will be updated
     * to show the 'Refreshing' view, and be scrolled to show such.
     */
