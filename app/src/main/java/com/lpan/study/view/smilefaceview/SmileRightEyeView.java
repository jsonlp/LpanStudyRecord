...
public class SmileRightEyeView extends View {
    ...
    public SmileRightEyeView(Context context) {
        super(context);
        init();
    }

    public SmileRightEyeView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public SmileRightEyeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
