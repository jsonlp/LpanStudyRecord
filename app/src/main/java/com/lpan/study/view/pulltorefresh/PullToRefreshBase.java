...
import com.lpan.study.view.pulltorefresh.internal.FlipLoadingLayout;
import com.lpan.study.view.pulltorefresh.internal.JiemoLoadingLayout;
import com.lpan.study.view.pulltorefresh.internal.LoadingLayout;
import com.lpan.study.view.pulltorefresh.internal.RotateLoadingLayout;
import com.lpan.study.view.pulltorefresh.internal.ViewCompat;
import com.lpan.study.view.pulltorefresh.listener.InternalRefreshListener;
import com.lpan.study.view.pulltorefresh.listener.InternalStretchListener;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements
    ...
    public static final int MSG_RESET = 111;

    public static final int MSG_PULL_LOAD = 222;
    ...
    protected boolean mUserWuyaLoading = true;
    ...
    private boolean mNeedRefreshOnSizeChanged;
    ...
    private InternalStretchListener mInternalStretchListener;

    private InternalRefreshListener mInternalRefreshListener;

    private boolean mNeedFixOnLayout;

    private boolean mHaveActionbar = true;
    ...
    private Handler mHandler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_PULL_LOAD:
                    int index = msg.arg1;
                    setState(State.PULL_LOAD_RESET);
                    onPullLoadComplete(index);
                    break;
    ...
    private boolean scrollingDisable = false;

    public boolean isScrollingDisable() {
        return scrollingDisable;
    }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        if (mInternalStretchListener != null && mInternalStretchListener.isStretchModeEnable()) {
            return mInternalStretchListener.stretchModeOnInterceptTouchEvent(event);
        } else {
            return refreshModeOnInterceptTouchEvent(event);
        }
    }
    ...
    private boolean refreshModeOnInterceptTouchEvent(MotionEvent event) {
    ...
    public final void onRefreshComplete() {
        if (isRefreshing()) {
            mHandler.sendEmptyMessageDelayed(MSG_RESET,500);
        }
    }
    ...
    public final void onPullToLoadComplete(int index) {
        if (isRefreshing()) {
            setState(State.PULL_LOAD_RESET);
            onPullLoadComplete(index);
        }
    ...
    public final boolean onTouchEvent(MotionEvent event) {
        ...
        if (mInternalStretchListener != null && mInternalStretchListener.isStretchModeEnable()) {
            return mInternalStretchListener.stretchModeOnTouchEvent(event);
        } else {
            return refreshModeOnTouchEvent(event);
        }
    }

    private boolean refreshModeOnTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_MOVE: {
                if (mIsBeingDragged) {
                    ...
                    pullEvent();
                    if (mInternalRefreshListener != null) {
                        mInternalRefreshListener.refreshModeOnTouchEvent(mLastMotionY
                                - mInitialMotionY);
                    }
                    return true;
                }
    ...
    public final void setState(State state, final boolean... params) {
        ...
        switch (mState) {
            ...
            case MANUAL_REFRESHING:
                onRefreshing(mState, params[0]);
                break;
            case OVERSCROLLING:
                // NO-OP
                break;

            case PULL_LOAD_RESET:
                onPullLoadReset();
                break;
        }
    ...
    protected LoadingLayout createLoadingLayout(Context context, Mode mode, TypedArray attrs) {
        return createLoadingLayout(context, mode, attrs, false);
    }

    protected LoadingLayout createLoadingLayout(Context context, Mode mode, TypedArray attrs,
                                                boolean enableBackground) {
        LoadingLayout layout = mLoadingAnimationStyle.createLoadingLayout(context, mode,
                getPullToRefreshScrollDirection(), attrs, enableBackground);
     ...
     * If you need to use a custom View (such as a custom ListView),
     ...
     * @param attrs   AttributeSet from wrapped class. Means that anything
     *                you include in the XML layout declaration will be routed to
     *                the created View
    ...
    /**
     * Implemented by derived class to return whether the View is in a
     * state where the user can Pull to Refresh by scrolling from the end.
     *
    ...
    /**
     * Implemented by derived class to return whether the View is in a
     * state where the user can Pull to Refresh by scrolling from the
     * start.
     *
     * @return true if the View is currently the correct state (for
     * example, top of a ListView)
     */
     ...
     *
     * @param savedInstanceState - Bundle which contains saved instance
     *                           state.
     */
     ...
     */
    protected void onRefreshing(final State state, final boolean doScroll) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        //                + "  mNeedFixOnLayout=" + mNeedFixOnLayout);
    ...
    protected final void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        /**
         * As we're currently in a Layout Pass, we need to schedule another
         * one to layout any changes we've made here
         */
    ...
    protected final void refreshLoadingViewsSize() {
        ...
        final int maximumPullScroll = mHeaderLayout.getContentSize();
    ...
    protected final void setHeaderScroll(int value) {
        ...
        if (USE_HW_LAYERS) {
             ...
             * scrolled at all. We don't use them on the Header/Footer
             * Views as they change often, which would negate any HW layer
             * performance boost.
             */
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (a.hasValue(R.styleable.PullToRefresh_ptrUseJiemoLoading)) {
            mUserWuyaLoading = a.getBoolean(R.styleable.PullToRefresh_ptrUseJiemoLoading, false);
        }
        ...
        mHeaderLayout = createLoadingLayout(context, mUserWuyaLoading ? Mode.USER_WUYA_LOADING
                : Mode.PULL_FROM_START, a, true);
    ...
    public void setInternalStretchListener(InternalStretchListener listener) {
        this.mInternalStretchListener = listener;
    }

    public boolean isNeedRefreshOnSizeChanged() {
        return mNeedRefreshOnSizeChanged;
    }
    ...
    public void setNeedRefreshOnSizeChanged(boolean mNeedRefreshOnSizeChanged) {
        this.mNeedRefreshOnSizeChanged = mNeedRefreshOnSizeChanged;
    }

    public void setNeedFixOnLayout(boolean fix) {
        this.mNeedFixOnLayout = fix;
    }

    public void setInternalRefreshListener(InternalRefreshListener mInternalRefreshListener) {
        this.mInternalRefreshListener = mInternalRefreshListener;
    }

    public boolean haveActionbar() {
        return mHaveActionbar;

    }

    public void setHaveActionbar(boolean haveActionbar) {
        this.mHaveActionbar = haveActionbar;
    ...
    public int getActionbarHeight() {
        ...
        return mHaveActionbar ? ViewUtils.getActionbarHeight() : 0;
    }

    public void setUserWuyaLoading(boolean mUserWuyaLoading) {
        this.mUserWuyaLoading = mUserWuyaLoading;

    }

    public static enum AnimationStyle {
        /**
         * This is the default for Android-PullToRefresh. Allows you to use
         * any drawable, which is automatically rotated and used as a
         * Progress Bar.
         */
        ROTATE,

        /**
         * This is the old default, and what is commonly used on iOS. Uses
         * an arrow image which flips depending on where the user has
         * scrolled.
         */
        FLIP;
        ...
        LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection,
            ...
            if (mode == Mode.USER_WUYA_LOADING) {
                return new JiemoLoadingLayout(context, mode, scrollDirection, attrs,
                        enableBackground);
            }
            switch (this) {
                case ROTATE:
    ...
    public static enum Mode {
         ...
         * View to refresh. The start is either the Top or Left, depending
         * on the scrolling direction.
         */
        PULL_FROM_START(0x1),

        /**
         * Only allow the user to Pull from the end of the Refreshable View
         * to refresh. The start is either the Bottom or Right, depending
         * on the scrolling direction.
         */
        PULL_FROM_END(0x2),
        ...
        /**
         * @return true if this mode wants the Loading Layout Header to be
         * shown
         */
        ...
        /**
         * @return true if this mode wants the Loading Layout Footer to be
         * shown
         */
    ...
    public static enum State {
        ...
        /**
         * When the UI is being pulled by the user, but has not been pulled
         * far enough so that it refreshes when released.
         */
        PULL_TO_REFRESH(0x1),
    ...
    public static interface OnPullEventListener<V extends View> {
        ...
        /**
         * Called when the internal state has been changed, usually by the
         * user pulling.
         *
     ...
     * Refresh. This listener is different as it allows you to
     * differentiate between Pull Ups, and Pull Downs.
     *
     * @author Chris Banes
     */
    ...
    final class SmoothScrollRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (mStartTime == -1) {
                ...
                /**
                 * We do do all calculations in long to reduce software
                 * float calculations. We use 1000 as it gives us good
                 * accuracy and small rounding errors
                 */
                float normalizedTime = (1000 * (System.currentTimeMillis() - mStartTime))
                        / mDuration;
                normalizedTime = Math.max(Math.min(normalizedTime, 1000), 0);
                ratio = normalizedTime / 1000;
            ...
            if (mContinueRunning && mScrollToY != mCurrentY) {
                ...
                if (mInternalRefreshListener != null) {
                    mInternalRefreshListener.refreshModeOnBackEvent(ratio);
                }
            } else {
                if (mListener != null) {
                ...
                if (mInternalRefreshListener != null) {
                    mInternalRefreshListener.refreshModeOnBackEvent(1);
                }
            }
        }
